...
class TestMatmulAddDivideMultiply(test_ap_base.APTestBase):
    def setUp(self):
        self.dtype = 'float16'

        matmul_config = test_ap_base.MatmulConfig(B=1, M=3136, N=96, K=384)
    ...
    def test_subgraph(self):
        tensor_args = self.init_tensors(self.dtype, [self.x_shape, self.y_shape, self.b_shape, self.e1_shape, self.e2_shape])
